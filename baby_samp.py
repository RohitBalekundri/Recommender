...
def hybrid_uter_model(vector_size, num_users,num_items,  user_input1, user_fea1, item_input1, item_fea1, labels1,user_input_test, user_fea_test, item_input_test, item_fea_test, epochs, opt):
...
# plt.legend()
# plt.show()
# model_2, pred_4 = hybrid_uter_model(vector_size, num_users, user_input, user_fea, item_input, item_fea, labels,
